  ...
  return (
    <>
      ...
      <header className="hero">
        <button onClick={() => setView('admin')} style={{ position: 'absolute', top: '1.5rem', right: '1.5rem', background: 'var(--ink)', color: 'var(--yellow)', border: '3px solid var(--ink)', padding: '0.6rem 1.4rem', borderRadius: '999px', fontFamily: 'var(--display)', fontSize: '1rem', cursor: 'pointer', zIndex: 10, transition: 'transform 0.2s', boxShadow: '4px 4px 0 var(--pink)' }}>Admin Dashboard &rarr;</button>
